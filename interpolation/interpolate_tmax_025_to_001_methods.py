...
"""
interpolate_tmax_025_to_001_methods.py

Interpolate CN_YANHAI_DOWN Tmax from 0.25 degree to high-resolution grid constrained by coastal001mask.
...
Input:
    /public/home/ggao001/users/xhang/Projects/CN_YANHAI_DOWN/01data/coastal_daily_025/CN05.1_Tmax_1961_2025_daily_025x025_coastal.nc

Mask constraint:
    /public/home/ggao001/users/xhang/Projects/CN_YANHAI_DOWN/01data/coastal_masks/coastal001mask.nc

Outputs:
    /public/home/ggao001/users/xhang/Projects/CN_YANHAI_DOWN/02models/01bilinear/tmax_001_bilinear.nc
    /public/home/ggao001/users/xhang/Projects/CN_YANHAI_DOWN/02models/02kriging/tmax_001_kriging.nc
    /public/home/ggao001/users/xhang/Projects/CN_YANHAI_DOWN/02models/03IDW/tmax_001_idw.nc
...
# Default paths
# =========================================================
DEFAULT_INPUT = "/public/home/ggao001/users/xhang/Projects/CN_YANHAI_DOWN/01data/coastal_daily_025/CN05.1_Tmax_1961_2025_daily_025x025_coastal.nc"
DEFAULT_MASK = "/public/home/ggao001/users/xhang/Projects/CN_YANHAI_DOWN/01data/coastal_masks/coastal001mask.nc"

DEFAULT_BILINEAR_OUT = "/public/home/ggao001/users/xhang/Projects/CN_YANHAI_DOWN/02models/01bilinear/tmax_001_bilinear.nc"
DEFAULT_KRIGING_OUT = "/public/home/ggao001/users/xhang/Projects/CN_YANHAI_DOWN/02models/02kriging/tmax_001_kriging.nc"
DEFAULT_IDW_OUT = "/public/home/ggao001/users/xhang/Projects/CN_YANHAI_DOWN/02models/03IDW/tmax_001_idw.nc"
...
def run_bilinear(
    ...
    ds_out, var_out = create_time_lat_lon_netcdf(
        ...
        attrs={
            "title": "Daily Tmax interpolated from 0.25 degree using bilinear interpolation",
            "method": "bilinear",
            "source_file": DEFAULT_INPUT,
            "constraint_mask": DEFAULT_MASK,
            "created_at": datetime.now().strftime("%Y-%m-%d %H:%M:%S"),
        },
        var_attrs={
...
def run_weighted_method(
    ...
    ds_out, var_out = create_time_lat_lon_netcdf(
        ...
        lon_values=target_lon,
        attrs={
            "title": f"Daily Tmax interpolated from 0.25 degree using {method_name}",
            "method": method_name,
            "source_file": DEFAULT_INPUT,
            "constraint_mask": DEFAULT_MASK,
            "created_at": datetime.now().strftime("%Y-%m-%d %H:%M:%S"),
...
def main():
    parser = argparse.ArgumentParser(description="Interpolate Tmax 0.25 degree to target grid using bilinear, IDW, and kriging.")
    ...
    log("=" * 100)
    log("Tmax interpolation from 0.25 degree to target grid")
    log("=" * 100)
    ...
    ds_src, da_src, time_name, lat_name, lon_name, src_var, time_values, source_lat, source_lon = load_time_lat_lon_field(
        args.input,
        preferred_names=[args.var, "tmax", "Tmax", "tasmax", "Band1"],
        var_name=args.var,
    )
