...
Outputs:
    ./outputs/interpolation/tmax/01bilinear/tmax_001_bilinear.nc
    ./outputs/interpolation/tmax/02kriging/tmax_001_kriging.nc
    ./outputs/interpolation/tmax/03IDW/tmax_001_idw.nc
...
# Default paths
# =========================================================
DEFAULT_INPUT = "./data/coastal_daily_025/CN05.1_Tmax_1961_2025_daily_025x025_coastal.nc"
DEFAULT_MASK = "./data/coastal_masks/coastal001mask.nc"

DEFAULT_BILINEAR_OUT = "./outputs/interpolation/tmax/01bilinear/tmax_001_bilinear.nc"
DEFAULT_KRIGING_OUT = "./outputs/interpolation/tmax/02kriging/tmax_001_kriging.nc"
DEFAULT_IDW_OUT = "./outputs/interpolation/tmax/03IDW/tmax_001_idw.nc"
