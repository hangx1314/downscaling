...
Evaluate final downscaled daily field on the temporal hold-out period (2016-2025).
...
DEFAULT_PRED = "./outputs/tmin/unet/unet005/outputs/tmin_005_final.nc"
DEFAULT_REF = "./data/coastal_daily_025/CN05.1_Tmin_1961_2025_daily_025x025_coastal.nc"
DEFAULT_OUT = "./outputs/tmin/unet/unet005/metrics/tmin_005_holdout_2016_2025.csv"
