...
- U-Net-predicted monthly climatology on 0.01-degree grid
...
DEFAULT_SOURCE_CLIM = "./outputs/tmin/unet/unet001/interim/tmin_005_clim_monthly.nc"
DEFAULT_CLIM001_PATH = "./outputs/tmin/unet/unet001/interim/tmin_001_clim_unet.nc"
DEFAULT_ANOM001_PATH = "./outputs/tmin/unet/unet001/interim/tmin_001_anom_interp.nc"
DEFAULT_OUT_PATH = "./outputs/tmin/unet/unet001/interim/tmin_001_raw.nc"
...
def main():
    ...
    parser.add_argument("--clim001", default=DEFAULT_CLIM001_PATH, help="Input U-Net-predicted 0.01-degree monthly climatology NetCDF")
