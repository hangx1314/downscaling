...
DEFAULT_CLIM005_PATH = "./outputs/tmin/unet/unet001/interim/tmin_005_clim_monthly.nc"

DEFAULT_MODEL_DIR = "./outputs/tmin/unet/unet001/models"
DEFAULT_METRICS_CSV = "./outputs/tmin/unet/unet001/models/unet001_train_metrics.csv"
DEFAULT_IMPORTANCE_CSV = "./outputs/tmin/unet/unet001/models/unet001_feature_importance_proxy.csv"
DEFAULT_FIT_NC = "./outputs/tmin/unet/unet001/interim/tmin_005_clim_unet001_fit.nc"
