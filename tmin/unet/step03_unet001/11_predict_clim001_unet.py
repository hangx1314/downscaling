...
# Default paths
# =========================================================
DEFAULT_PRED001_PATH = "./data/coastal_static/predictors_001_static.nc"
DEFAULT_MODEL_DIR = "./outputs/tmin/unet/unet001/models"
DEFAULT_SOURCE_CLIM = "./outputs/tmin/unet/unet001/interim/tmin_005_clim_monthly.nc"
DEFAULT_OUT_PATH = "./outputs/tmin/unet/unet001/interim/tmin_001_clim_unet.nc"
...
def main():
    ...
    ds_out["clim_tmin_unet"].attrs = {
        "long_name": "UNet-001 predicted monthly climatology of Tmin on 0.01-degree grid",
        "units": "",
    }
