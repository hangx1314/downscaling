...
DEFAULT_CLIM025_PATH = "/public/home/ggao001/users/xhang/Projects/zcn/tmin/05unet/02exp/unet005/interim/tmin_025_clim_monthly.nc"

DEFAULT_MODEL_DIR = "/public/home/ggao001/users/xhang/Projects/zcn/tmin/05unet/02exp/unet005/models"
DEFAULT_METRICS_CSV = "/public/home/ggao001/users/xhang/Projects/zcn/tmin/05unet/02exp/unet005/models/unet005_train_metrics.csv"
DEFAULT_IMPORTANCE_CSV = "/public/home/ggao001/users/xhang/Projects/zcn/tmin/05unet/02exp/unet005/models/unet005_feature_importance_proxy.csv"
DEFAULT_FIT_NC = "/public/home/ggao001/users/xhang/Projects/zcn/tmin/05unet/02exp/unet005/interim/tmin_025_clim_unet005_fit.nc"
...
def main():
    ...
    if args.month is not None:
        ...
        ds_fit_part = xr.Dataset(
            {
                "clim_tmin_unet005_fit": (("month", "lat", "lon"), fit_cube[month_row:month_row + 1].astype(np.float32)),
            },
            coords={
        ...
        ds_fit_part.to_netcdf(
            fit_part_path,
            encoding={"clim_tmin_unet005_fit": {"zlib": True, "complevel": 4, "dtype": "float32"}},
        )
        ds_tgt.close()
    ...
    ds_fit["clim_tmin_unet005_fit"].attrs = {
