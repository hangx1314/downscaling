...
DEFAULT_ANOM025_PATH = "/public/home/ggao001/users/xhang/Projects/zcn/tmin/03random_f/02exp/rf005/interim/tmin_025_anom_daily.nc"
DEFAULT_MASK005_PATH = "/public/home/ggao001/users/xhang/Projects/CN_YANHAI_DOWN/01data/coastal_masks/coastal005mask.nc"
DEFAULT_OUT_PATH = "/public/home/ggao001/users/xhang/Projects/zcn/tmin/03random_f/02exp/rf005/interim/tmin_005_anom_interp.nc"
...
def main():
    ...
    da_interp.name = "anom_tmin_interp"
    da_interp.attrs = {
        "long_name": "Daily anomaly of Tmin interpolated from 0.25-degree to 0.05-degree grid",
    ...
    ds_out = xr.Dataset(
        {"anom_tmin_interp": da_interp.astype(np.float32)},
        attrs={
            "title": "Interpolated daily anomaly of Tmin on 0.05-degree grid",
