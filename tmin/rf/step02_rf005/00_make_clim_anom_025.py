...
Build monthly climatology and daily anomaly from 0.25-degree daily Tmin.
...
# Default paths
# =========================================================
DEFAULT_TMIN_PATH = "/public/home/ggao001/users/xhang/Projects/CN_YANHAI_DOWN/01data/coastal_daily_025/CN05.1_Tmin_1961_2025_daily_025x025_coastal.nc"
DEFAULT_CLIM_OUT = "/public/home/ggao001/users/xhang/Projects/zcn/tmin/03random_f/02exp/rf005/interim/tmin_025_clim_monthly.nc"
DEFAULT_ANOM_OUT = "/public/home/ggao001/users/xhang/Projects/zcn/tmin/03random_f/02exp/rf005/interim/tmin_025_anom_daily.nc"
...
def main():
    parser = argparse.ArgumentParser(description="Build monthly climatology and daily anomaly from 0.25-degree Tmin.")
    parser.add_argument("--input", default=DEFAULT_TMIN_PATH, help="Input daily Tmin NetCDF")
    ...
    if args.var is not None:
        ...
        var_name = find_3d_target_var(
            ...
            lat_name,
            lon_name,
            preferred_names=["tmin", "Tmin", "tmx", "tasmax", "Band1"]
        )
    ...
    clim.attrs = {
        "long_name": "Monthly climatology of Tmin on 0.25-degree grid",
    ...
    anom.attrs = {
        "long_name": "Daily anomaly of Tmin relative to monthly climatology on 0.25-degree grid",
        "units": da.attrs.get("units", ""),
        "source_variable": var_name,
        "definition": "daily_tmin - monthly_climatology",
    }

    ds_clim = xr.Dataset(
        {"clim_tmin": clim},
        attrs={
            "title": "Monthly climatology of 0.25-degree Tmin",
    ...
    ds_anom = xr.Dataset(
        {"anom_tmin": anom},
        attrs={
            "title": "Daily anomaly of 0.25-degree Tmin",
            "created_at": datetime.now().strftime("%Y-%m-%d %H:%M:%S"),
            "source_file": args.input,
            "source_variable": var_name,
        },
    ...
    clim_encoding = {"clim_tmin": {"zlib": True, "complevel": 4, "dtype": "float32"}}
    anom_encoding = {"anom_tmin": {"zlib": True, "complevel": 4, "dtype": "float32"}}
