...
# Default paths
# =========================================================
DEFAULT_SOURCE_CLIM = "/public/home/ggao001/users/xhang/Projects/zcn/tmin/03random_f/02exp/rf005/interim/tmin_025_clim_monthly.nc"
DEFAULT_CLIM005_PATH = "/public/home/ggao001/users/xhang/Projects/zcn/tmin/03random_f/02exp/rf005/interim/tmin_005_clim_rf.nc"
DEFAULT_ANOM005_PATH = "/public/home/ggao001/users/xhang/Projects/zcn/tmin/03random_f/02exp/rf005/interim/tmin_005_anom_interp.nc"
DEFAULT_OUT_PATH = "/public/home/ggao001/users/xhang/Projects/zcn/tmin/03random_f/02exp/rf005/interim/tmin_005_raw.nc"
...
def load_clim(clim_path: str, clim_var_name: str = None):
    ...
    if clim_var_name is not None:
        ...
        var_name = find_monthly_var(
            ...
            lat_name,
            lon_name,
            preferred_names=["clim_tmin_rf", "clim_tmin", "tmin_clim_rf", "Band1"]
        )
...
def load_anom(anom_path: str, anom_var_name: str = None):
    ...
    if anom_var_name is not None:
        ...
        var_name = find_time_var(
            ...
            lat_name,
            lon_name,
            preferred_names=["anom_tmin_interp", "anom_tmin", "tmin_anom_interp", "Band1"]
        )
...
def main():
    parser = argparse.ArgumentParser(description="Build initial 0.05-degree daily Tmin from monthly climatology and anomaly.")
    ...
    parser.add_argument("--out", default=DEFAULT_OUT_PATH, help="Output 0.05-degree daily raw Tmin NetCDF")
    ...
    log("Combining climatology and anomaly to build initial daily Tmin")
    da_raw = da_clim_daily_std + da_anom_std

    da_raw.name = "tmin_005_raw"
    da_raw.attrs = {
        "long_name": "Initial daily Tmin on 0.05-degree grid before residual correction",
    ...
    ds_out = xr.Dataset(
        {"tmin_005_raw": da_raw.astype(np.float32)},
        attrs={
            "title": "Initial daily Tmin on 0.05-degree grid",
