...
"""
16_predict_clim001_rf.py

Predict 0.01-degree monthly climatology using trained RF-001 monthly models.
...
DEFAULT_MODEL_DIR = "/public/home/ggao001/users/xhang/Projects/zcn/tmin/03random_f/02exp/rf001/models"
DEFAULT_SOURCE_CLIM = "/public/home/ggao001/users/xhang/Projects/zcn/tmin/03random_f/02exp/rf001/interim/tmin_005_clim_monthly.nc"
DEFAULT_OUT_PATH = "/public/home/ggao001/users/xhang/Projects/zcn/tmin/03random_f/02exp/rf001/interim/tmin_001_clim_rf.nc"
...
def get_model_path(model_dir: str, month_int: int) -> str:
    return os.path.join(model_dir, f"rf001_month_{month_int:02d}.joblib")
...
def main():
    parser = argparse.ArgumentParser(description="Predict 0.01-degree monthly climatology using trained RF-001 models.")
    ...
    first_model_path = find_first_model_path(args.model_dir, "rf001", train_months)
    ...
    ds_out = xr.Dataset(
        ...
        attrs={
            "title": "RF-001 predicted monthly climatology on 0.01-degree grid",
    ...
    ds_out["clim_tmin_rf"].attrs = {
        "long_name": "RF-001 predicted monthly climatology of Tmin on 0.01-degree grid",
        "units": "",
    }
    ...
    encoding = {"clim_tmin_rf": {"zlib": True, "complevel": 4, "dtype": "float32"}}
