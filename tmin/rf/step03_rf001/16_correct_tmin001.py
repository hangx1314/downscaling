...
DEFAULT_RES001_PATH = "/public/home/ggao001/users/xhang/Projects/zcn/tmin/03random_f/02exp/rf001/interim/residual_001_interp.nc"
DEFAULT_MASK001_PATH = "/public/home/ggao001/users/xhang/Projects/CN_YANHAI_DOWN/01data/coastal_masks/coastal001mask.nc"
DEFAULT_OUT_PATH = "/public/home/ggao001/users/xhang/Projects/zcn/tmin/03random_f/02exp/rf001/interim/tmin_001_corr.nc"
...
def main():
    parser = argparse.ArgumentParser(description="Apply interpolated residual correction to 0.01-degree daily Tmin.")
    ...
    parser.add_argument("--out", default=DEFAULT_OUT_PATH, help="Output corrected 0.01-degree Tmin NetCDF")
    ...
    ds_raw, da_raw, raw_time_name, raw_lat_name, raw_lon_name, raw_var_name = load_field(
        args.raw001,
        default_names=["tmin_001_raw", "tmin", "Band1"],
    ...
    ds_res, da_res, res_time_name, res_lat_name, res_lon_name, res_var_name = load_field(
        args.res001,
        default_names=["residual_tmin_001_interp", "residual_tmin_001", "residual", "Band1"],
    ...
    write_corrected_sum_netcdf_time_chunked(
        ...
        var_attrs={
            "long_name": "Residual-corrected daily Tmin on 0.01-degree grid",
            "units": da_raw.attrs.get("units", da_res.attrs.get("units", "")),
            "definition": "tmin_001_raw + residual_tmin_001_interp",
        ...
        ds_attrs={
            "title": "Residual-corrected daily Tmin on 0.01-degree grid",
        ...
        encoding={"tmin_001_corr": {"zlib": True, "complevel": 4, "dtype": "float32"}},
        log_fn=log,
        mask2d=mask2d,
    )
