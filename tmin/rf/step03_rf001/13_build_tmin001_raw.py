...
"""
18_build_tmin001_raw.py

Build initial 0.01-degree daily Tmin by combining:
...
DEFAULT_CLIM001_PATH = "/public/home/ggao001/users/xhang/Projects/zcn/tmin/03random_f/02exp/rf001/interim/tmin_001_clim_rf.nc"
DEFAULT_ANOM001_PATH = "/public/home/ggao001/users/xhang/Projects/zcn/tmin/03random_f/02exp/rf001/interim/tmin_001_anom_interp.nc"
DEFAULT_OUT_PATH = "/public/home/ggao001/users/xhang/Projects/zcn/tmin/03random_f/02exp/rf001/interim/tmin_001_raw.nc"
...
def main():
    parser = argparse.ArgumentParser(description="Build initial 0.01-degree daily Tmin from monthly climatology and anomaly.")
    ...
    parser.add_argument("--out", default=DEFAULT_OUT_PATH, help="Output 0.01-degree daily raw Tmin NetCDF")
    ...
    log(f"Building initial daily Tmin in time chunks of {args.time_chunk}")
    out_var = "tmin_001_raw"
    var_attrs = {
        "long_name": "Initial daily Tmin on 0.01-degree grid before residual correction",
    ...
    ds_attrs = {
        "title": "Initial daily Tmin on 0.01-degree grid",
