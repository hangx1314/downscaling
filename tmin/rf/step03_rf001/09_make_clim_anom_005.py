...
Build monthly climatology and daily anomaly from 0.05-degree daily Tmin.
...
DEFAULT_CLIM_OUT = "/public/home/ggao001/users/xhang/Projects/zcn/tmin/03random_f/02exp/rf001/interim/tmin_005_clim_monthly.nc"
DEFAULT_ANOM_OUT = "/public/home/ggao001/users/xhang/Projects/zcn/tmin/03random_f/02exp/rf001/interim/tmin_005_anom_daily.nc"
...
def main():
    parser = argparse.ArgumentParser(description="Build monthly climatology and daily anomaly from 0.05-degree Tmin.")
    parser.add_argument("--input", default=DEFAULT_TMIN005_PATH, help="Input daily Tmin NetCDF")
    ...
    clim.attrs = {
        "long_name": "Monthly climatology of Tmin on 0.05-degree grid",
    ...
    anom.attrs = {
        "long_name": "Daily anomaly of Tmin relative to monthly climatology on 0.05-degree grid",
        "units": da.attrs.get("units", ""),
        "source_variable": var_name,
    ...
    ds_clim = xr.Dataset(
        {"clim_tmin": clim},
        attrs={
            "title": "Monthly climatology of 0.05-degree Tmin",
    ...
    ds_anom = xr.Dataset(
        {"anom_tmin": anom},
        attrs={
            "title": "Daily anomaly of 0.05-degree Tmin",
            "created_at": datetime.now().strftime("%Y-%m-%d %H:%M:%S"),
            "source_file": args.input,
            "source_variable": var_name,
        },
