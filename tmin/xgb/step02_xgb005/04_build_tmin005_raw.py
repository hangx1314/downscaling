...
- XGBoost-predicted monthly climatology on 0.05-degree grid
...
# Default paths
# =========================================================
DEFAULT_SOURCE_CLIM = "./outputs/tmin/xgb/xgb005/interim/tmin_025_clim_monthly.nc"
DEFAULT_CLIM005_PATH = "./outputs/tmin/xgb/xgb005/interim/tmin_005_clim_xgb.nc"
DEFAULT_ANOM005_PATH = "./outputs/tmin/xgb/xgb005/interim/tmin_005_anom_interp.nc"
DEFAULT_OUT_PATH = "./outputs/tmin/xgb/xgb005/interim/tmin_005_raw.nc"
...
def load_clim(clim_path: str, clim_var_name: str = None):
    ...
    if clim_var_name is not None:
        ...
        var_name = find_monthly_var(
            ...
            lat_name,
            lon_name,
            preferred_names=["clim_tmin_xgb", "clim_tmin", "tmin_clim_xgb", "Band1"]
        )
...
def main():
    ...
    parser.add_argument("--clim005", default=DEFAULT_CLIM005_PATH, help="Input XGBoost-predicted 0.05-degree monthly climatology NetCDF")
