...
- y: 0.25-degree monthly climatology of Tmin

Inputs:
- predictors_025_static.nc
- tmin_025_clim_monthly.nc

Outputs:
- xgb005_month_01.joblib ... xgb005_month_12.joblib
- xgb005_train_metrics.csv
- xgb005_feature_importance.csv
- tmin_025_clim_xgb005_fit.nc
"""
...
DEFAULT_CLIM_PATH = "/public/home/ggao001/users/xhang/Projects/zcn/tmin/04xgb/02exp/xgb005/interim/tmin_025_clim_monthly.nc"

DEFAULT_MODEL_DIR = "/public/home/ggao001/users/xhang/Projects/zcn/tmin/04xgb/02exp/xgb005/models"
DEFAULT_METRICS_CSV = "/public/home/ggao001/users/xhang/Projects/zcn/tmin/04xgb/02exp/xgb005/models/xgb005_train_metrics.csv"
DEFAULT_IMPORTANCE_CSV = "/public/home/ggao001/users/xhang/Projects/zcn/tmin/04xgb/02exp/xgb005/models/xgb005_feature_importance.csv"
DEFAULT_FIT_NC = "/public/home/ggao001/users/xhang/Projects/zcn/tmin/04xgb/02exp/xgb005/interim/tmin_025_clim_xgb005_fit.nc"
...
def main():
    ...
    ds_fit["clim_tmin_xgb005_fit"].attrs = {
    ...
    ds_fit.to_netcdf(
        args.fit_nc,
        encoding={"clim_tmin_xgb005_fit": {"zlib": True, "complevel": 4, "dtype": "float32"}},
    )
