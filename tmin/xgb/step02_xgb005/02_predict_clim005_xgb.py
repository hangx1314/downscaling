...
"""
07_predict_clim005_xgb.py

Predict 0.05-degree monthly climatology using trained XGB-005 monthly models.
...
DEFAULT_SOURCE_CLIM = "/public/home/ggao001/users/xhang/Projects/zcn/tmin/04xgb/02exp/xgb005/interim/tmin_025_clim_monthly.nc"
DEFAULT_OUT_PATH = "/public/home/ggao001/users/xhang/Projects/zcn/tmin/04xgb/02exp/xgb005/interim/tmin_005_clim_xgb.nc"
...
def get_model_path(model_dir: str, month_int: int) -> str:
    return os.path.join(model_dir, f"xgb005_month_{month_int:02d}.joblib")
...
def main():
    parser = argparse.ArgumentParser(description="Predict 0.05-degree monthly climatology using trained XGB-005 models.")
    ...
    first_model_path = find_first_model_path(args.model_dir, "xgb005", train_months)
    ...
    ds_out = xr.Dataset(
        ...
        attrs={
            "title": "XGB-005 predicted monthly climatology on 0.05-degree grid",
    ...
    ds_out["clim_tmin_xgb"].attrs = {
        "long_name": "XGB-005 predicted monthly climatology of Tmin on 0.05-degree grid",
        "units": "",
    }
