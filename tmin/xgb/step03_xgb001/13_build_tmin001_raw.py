...
- XGBoost-predicted monthly climatology on 0.01-degree grid
...
DEFAULT_CLIM001_PATH = "./outputs/tmin/xgb/xgb001/interim/tmin_001_clim_xgb.nc"
DEFAULT_ANOM001_PATH = "./outputs/tmin/xgb/xgb001/interim/tmin_001_anom_interp.nc"
DEFAULT_OUT_PATH = "./outputs/tmin/xgb/xgb001/interim/tmin_001_raw.nc"
...
def main():
    ...
    parser.add_argument("--clim001", default=DEFAULT_CLIM001_PATH, help="Input XGBoost-predicted 0.01-degree monthly climatology NetCDF")
