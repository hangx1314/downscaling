...
- y: 0.05-degree monthly climatology of Tmax
...
Outputs:
- xgb001_month_01.joblib ... xgb001_month_12.joblib
- xgb001_train_metrics.csv
- xgb001_feature_importance.csv
- tmax_005_clim_xgb001_fit.nc
"""
...
DEFAULT_PRED_PATH = "/public/home/ggao001/users/xhang/Projects/CN_YANHAI_DOWN/01data/coastal_static/predictors_005_static.nc"
DEFAULT_CLIM_PATH = "/public/home/ggao001/users/xhang/Projects/zcn/tmax/04xgb/02exp/xgb001/interim/tmax_005_clim_monthly.nc"

DEFAULT_MODEL_DIR = "/public/home/ggao001/users/xhang/Projects/zcn/tmax/04xgb/02exp/xgb001/models"
DEFAULT_METRICS_CSV = "/public/home/ggao001/users/xhang/Projects/zcn/tmax/04xgb/02exp/xgb001/models/xgb001_train_metrics.csv"
DEFAULT_IMPORTANCE_CSV = "/public/home/ggao001/users/xhang/Projects/zcn/tmax/04xgb/02exp/xgb001/models/xgb001_feature_importance.csv"
DEFAULT_FIT_NC = "/public/home/ggao001/users/xhang/Projects/zcn/tmax/04xgb/02exp/xgb001/interim/tmax_005_clim_xgb001_fit.nc"
...
def main():
    ...
    for im, month_value in enumerate(months):
        ...
        model_path = os.path.join(args.model_dir, f"xgb001_month_{month_int:02d}.joblib")
        payload = {
            "model": final_model,
    ...
    ds_fit = xr.Dataset(
        ...
        attrs={
            "title": "XGB-005 fitted monthly climatology on 0.05-degree grid",
    ...
    ds_fit["clim_tmax_xgb001_fit"].attrs = {
    ...
    ds_fit.to_netcdf(
        args.fit_nc,
        encoding={"clim_tmax_xgb001_fit": {"zlib": True, "complevel": 4, "dtype": "float32"}},
    )
