...
DEFAULT_SOURCE_CLIM = "/public/home/ggao001/users/xhang/Projects/zcn/tmax/04xgb/02exp/xgb001/interim/tmax_005_clim_monthly.nc"
DEFAULT_OUT_PATH = "/public/home/ggao001/users/xhang/Projects/zcn/tmax/04xgb/02exp/xgb001/interim/tmax_001_clim_xgb.nc"
...
def main():
    ...
    ds_out = xr.Dataset(
        data_vars={
            "clim_tmax_xgb": (("month", "lat", "lon"), clim_out.astype(np.float32))
        },
        coords={
    ...
    ds_out["clim_tmax_xgb"].attrs = {
        "long_name": "XGB-001 predicted monthly climatology of Tmax on 0.01-degree grid",
        "units": "",
    }
    ...
    encoding = {"clim_tmax_xgb": {"zlib": True, "complevel": 4, "dtype": "float32"}}
