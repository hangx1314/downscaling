...
DEFAULT_CLIM005_PATH = "./outputs/tmax/unet/unet001/interim/tmax_005_clim_monthly.nc"

DEFAULT_MODEL_DIR = "./outputs/tmax/unet/unet001/models"
DEFAULT_METRICS_CSV = "./outputs/tmax/unet/unet001/models/unet001_train_metrics.csv"
DEFAULT_IMPORTANCE_CSV = "./outputs/tmax/unet/unet001/models/unet001_feature_importance_proxy.csv"
DEFAULT_FIT_NC = "./outputs/tmax/unet/unet001/interim/tmax_005_clim_unet001_fit.nc"
...
def main():
    ...
    if args.month is not None:
        ...
        ds_fit_part = xr.Dataset(
            {
                "clim_tmax_unet001_fit": (("month", "lat", "lon"), fit_cube[month_row:month_row + 1].astype(np.float32)),
            },
            coords={
        ...
        ds_fit_part.to_netcdf(
            fit_part_path,
            encoding={"clim_tmax_unet001_fit": {"zlib": True, "complevel": 4, "dtype": "float32"}},
        )
        ds_tgt.close()
    ...
    ds_fit["clim_tmax_unet001_fit"].attrs = {
