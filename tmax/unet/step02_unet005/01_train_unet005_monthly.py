...
# Default paths
# =========================================================
DEFAULT_PRED025_PATH = "./data/coastal_static/predictors_025_static.nc"
DEFAULT_CLIM025_PATH = "./outputs/tmax/unet/unet005/interim/tmax_025_clim_monthly.nc"

DEFAULT_MODEL_DIR = "./outputs/tmax/unet/unet005/models"
DEFAULT_METRICS_CSV = "./outputs/tmax/unet/unet005/models/unet005_train_metrics.csv"
DEFAULT_IMPORTANCE_CSV = "./outputs/tmax/unet/unet005/models/unet005_feature_importance_proxy.csv"
DEFAULT_FIT_NC = "./outputs/tmax/unet/unet005/interim/tmax_025_clim_unet005_fit.nc"
...
class U_Net(nn.Module):
    ...
    """
    def __init__(self, in_ch=22, out_ch=1, base_channels=64):
        super(U_Net, self).__init__()

        n1 = int(base_channels)
...
def train_single_month(
    ...
    model = U_Net(in_ch=in_channels, out_ch=1, base_channels=args.base_channels).to(device)
