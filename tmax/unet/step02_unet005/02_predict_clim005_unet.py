...
DEFAULT_SOURCE_CLIM = "./outputs/tmax/unet/unet005/interim/tmax_025_clim_monthly.nc"
DEFAULT_OUT_PATH = "./outputs/tmax/unet/unet005/interim/tmax_005_clim_unet.nc"
...
def main():
    ...
    ds_out["clim_tmax_unet"].attrs = {
        "long_name": "UNet-005 predicted monthly climatology of Tmax on 0.05-degree grid",
        "units": "",
    }
