...
Steps:
1) Aggregate tmax_001_corr back to 0.05-degree grid
...
4) Save delta_005 and final tmax_001_final
...
DEFAULT_CORR001_PATH = "/public/home/ggao001/users/xhang/Projects/zcn/tmax/03random_f/02exp/rf001/interim/tmax_001_corr.nc"
DEFAULT_TMAX005_PATH = "/public/home/ggao001/users/xhang/Projects/zcn/tmax/03random_f/02exp/rf005/outputs/tmax_005_final.nc"
DEFAULT_DELTA_OUT = "/public/home/ggao001/users/xhang/Projects/zcn/tmax/03random_f/02exp/rf001/interim/delta_005_consistency.nc"
DEFAULT_FINAL_OUT = "/public/home/ggao001/users/xhang/Projects/zcn/tmax/03random_f/02exp/rf001/outputs/tmax_001_final.nc"
...
def main():
    parser = argparse.ArgumentParser(description="Apply strict 0.05-degree consistency correction to 0.01-degree Tmax.")
    parser.add_argument("--corr001", default=DEFAULT_CORR001_PATH, help="Input residual-corrected 0.01-degree Tmax NetCDF")
    ...
    parser.add_argument("--final-out", default=DEFAULT_FINAL_OUT, help="Output final 0.01-degree Tmax NetCDF")
    ...
    ds_corr, da_corr, corr_time_name, corr_lat_name, corr_lon_name, corr_var_name = load_field(
        args.corr001,
        default_names=["tmax_001_corr", "tmax", "Band1"],
    ...
    ds_tgt, da_tgt, tgt_time_name, tgt_lat_name, tgt_lon_name, tgt_var_name = load_field(
        args.target005,
        default_names=["tmax_005_final", "tmax", "Band1"],
    ...
    delta_da = xr.DataArray(
        ...
        attrs={
            ...
            "definition": "target_tmax_005 - aggregated_tmax_005_from_tmax_001_corr",
    ...
    final_da = xr.DataArray(
        ...
        name="tmax_001_final",
        attrs={
            "long_name": "Final daily Tmax on 0.01-degree grid after residual and consistency correction",
            "units": da_corr.attrs.get("units", da_tgt.attrs.get("units", "")),
            "definition": "tmax_001_corr + distributed_delta_005_consistency",
            "source_corr_file": args.corr001,
            "source_corr_variable": corr_var_name,
    ...
    ds_delta = xr.Dataset(
        ...
        attrs={
            "title": "0.05-degree consistency delta for 0.01-degree Tmax",
    ...
    ds_final = xr.Dataset(
        {"tmax_001_final": final_da},
        attrs={
            "title": "Final daily Tmax on 0.01-degree grid",
            "created_at": datetime.now().strftime("%Y-%m-%d %H:%M:%S"),
            "corr001_file": args.corr001,
            "corr001_variable": corr_var_name,
            "target005_file": args.target005,
    ...
    ds_final.to_netcdf(
        args.final_out,
        encoding={"tmax_001_final": {"zlib": True, "complevel": 4, "dtype": "float32"}}
    )
