...
DEFAULT_RES005_PATH = "/public/home/ggao001/users/xhang/Projects/zcn/tmax/03random_f/02exp/rf001/interim/residual_005_daily.nc"
DEFAULT_MASK001_PATH = "/public/home/ggao001/users/xhang/Projects/CN_YANHAI_DOWN/01data/coastal_masks/coastal001mask.nc"
DEFAULT_OUT_PATH = "/public/home/ggao001/users/xhang/Projects/zcn/tmax/03random_f/02exp/rf001/interim/residual_001_interp.nc"
...
def load_residual(path: str, var_name: str = None):
    ...
    if var_name is not None:
        ...
        target_var = find_3d_var(
            ...
            preferred_names=["residual_tmax_005", "residual", "Band1"]
        )
...
def main():
    ...
    write_interp_to_target_grid_with_mask_fill_netcdf(
        ...
        out_path=args.out,
        out_var="residual_tmax_001_interp",
        ...
        encoding={"residual_tmax_001_interp": {"zlib": True, "complevel": 4, "dtype": "float32"}},
        log_fn=log,
    )
