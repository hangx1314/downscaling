...
# Default paths
# =========================================================
DEFAULT_ANOM005_PATH = "/public/home/ggao001/users/xhang/Projects/zcn/tmax/03random_f/02exp/rf001/interim/tmax_005_anom_daily.nc"
DEFAULT_MASK001_PATH = "/public/home/ggao001/users/xhang/Projects/CN_YANHAI_DOWN/01data/coastal_masks/coastal001mask.nc"
DEFAULT_OUT_PATH = "/public/home/ggao001/users/xhang/Projects/zcn/tmax/03random_f/02exp/rf001/interim/tmax_001_anom_interp.nc"
...
def main():
    ...
    _ds_tmp = filter_dataset_to_output_months(da_anom.to_dataset(name="anom_tmax_interp"))
    da_anom = _ds_tmp["anom_tmax_interp"]
    ...
    write_interp_to_target_grid_with_mask_fill_netcdf(
        ...
        out_path=args.out,
        out_var="anom_tmax_interp",
        time_chunk=args.time_chunk,
        var_attrs={
            "long_name": da_anom.attrs.get("long_name", "anom_tmax_interp"),
