...
DEFAULT_MODEL_DIR = "/public/home/ggao001/users/xhang/Projects/zcn/tmax/03random_f/02exp/rf001/models"
...
DEFAULT_OUT_PATH = "/public/home/ggao001/users/xhang/Projects/zcn/tmax/03random_f/02exp/rf001/interim/tmax_001_clim_rf.nc"
...
def main():
    ...
    ds_out = xr.Dataset(
        data_vars={
            "clim_tmax_rf": (("month", "lat", "lon"), clim_out.astype(np.float32))
        },
        coords={
    ...
    ds_out["clim_tmax_rf"].attrs = {
        "long_name": "RF-001 predicted monthly climatology of Tmax on 0.01-degree grid",
        "units": "",
    }
    ...
    encoding = {"clim_tmax_rf": {"zlib": True, "complevel": 4, "dtype": "float32"}}
