...
DEFAULT_RES025_PATH = "/public/home/ggao001/users/xhang/Projects/zcn/tmax/03random_f/02exp/rf005/interim/residual_025_daily.nc"
DEFAULT_MASK005_PATH = "/public/home/ggao001/users/xhang/Projects/CN_YANHAI_DOWN/01data/coastal_masks/coastal005mask.nc"
DEFAULT_OUT_PATH = "/public/home/ggao001/users/xhang/Projects/zcn/tmax/03random_f/02exp/rf005/interim/residual_005_interp.nc"
...
def load_residual(path: str, var_name: str = None):
    ...
    if var_name is not None:
        ...
        target_var = find_3d_var(
            ...
            preferred_names=["residual_tmax_025", "residual", "Band1"]
        )
...
def main():
    ...
    da_interp.name = "residual_tmax_005_interp"
    da_interp.attrs = {
    ...
    ds_out = xr.Dataset(
        {"residual_tmax_005_interp": da_interp.astype(np.float32)},
        attrs={
    ...
    ds_out.to_netcdf(
        args.out,
        encoding={"residual_tmax_005_interp": {"zlib": True, "complevel": 4, "dtype": "float32"}}
    )
