...
DEFAULT_RAW005_PATH = "/public/home/ggao001/users/xhang/Projects/zcn/tmax/03random_f/02exp/rf005/interim/tmax_005_raw.nc"
DEFAULT_RES005_PATH = "/public/home/ggao001/users/xhang/Projects/zcn/tmax/03random_f/02exp/rf005/interim/residual_005_interp.nc"
DEFAULT_OUT_PATH = "/public/home/ggao001/users/xhang/Projects/zcn/tmax/03random_f/02exp/rf005/interim/tmax_005_corr.nc"
...
def main():
    parser = argparse.ArgumentParser(description="Apply interpolated residual correction to 0.05-degree daily Tmax.")
    ...
    parser.add_argument("--out", default=DEFAULT_OUT_PATH, help="Output corrected 0.05-degree Tmax NetCDF")
    ...
    ds_raw, da_raw, raw_time_name, raw_lat_name, raw_lon_name, raw_var_name = load_field(
        args.raw005,
        default_names=["tmax_005_raw", "tmax", "Band1"],
    ...
    ds_res, da_res, res_time_name, res_lat_name, res_lon_name, res_var_name = load_field(
        args.res005,
        default_names=["residual_tmax_005_interp", "residual_tmax_005", "residual", "Band1"],
    ...
    da_corr.name = "tmax_005_corr"
    da_corr.attrs = {
        "long_name": "Residual-corrected daily Tmax on 0.05-degree grid",
        "units": da_raw.attrs.get("units", da_res.attrs.get("units", "")),
        "definition": "tmax_005_raw + residual_tmax_005_interp",
    ...
    ds_out = xr.Dataset(
        {"tmax_005_corr": da_corr},
        attrs={
            "title": "Residual-corrected daily Tmax on 0.05-degree grid",
    ...
    ds_out.to_netcdf(
        args.out,
        encoding={"tmax_005_corr": {"zlib": True, "complevel": 4, "dtype": "float32"}}
    )
