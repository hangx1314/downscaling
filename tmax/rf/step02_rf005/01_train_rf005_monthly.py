...
"""
01_train_rf005_monthly.py

Train monthly RF-005 models with repeated spatial block cross-validation:
- X: 0.25-degree static predictors (CN_YANHAI_DOWN coastal_static)
...
- rf005_train_metrics.csv
- rf005_feature_importance.csv
- tmax_025_clim_rf_fit.nc
"""
...
DEFAULT_CLIM_PATH = "/public/home/ggao001/users/xhang/Projects/zcn/tmax/03random_f/02exp/rf005/interim/tmax_025_clim_monthly.nc"

DEFAULT_MODEL_DIR = "/public/home/ggao001/users/xhang/Projects/zcn/tmax/03random_f/02exp/rf005/models"
DEFAULT_METRICS_CSV = "/public/home/ggao001/users/xhang/Projects/zcn/tmax/03random_f/02exp/rf005/models/rf005_train_metrics.csv"
DEFAULT_IMPORTANCE_CSV = "/public/home/ggao001/users/xhang/Projects/zcn/tmax/03random_f/02exp/rf005/models/rf005_feature_importance.csv"
DEFAULT_FIT_NC = "/public/home/ggao001/users/xhang/Projects/zcn/tmax/03random_f/02exp/rf005/interim/tmax_025_clim_rf_fit.nc"
...
def main():
    parser = argparse.ArgumentParser(description="Train monthly RF-005 models with repeated spatial block CV.")
    ...
    for im, month_value in enumerate(months):
        ...
        model_path = os.path.join(args.model_dir, f"rf005" + f"_month_{month_int:02d}.joblib")
        payload = {
            "model": final_model,
    ...
    ds_fit = xr.Dataset(
        ...
        attrs={
            "title": "RF-005 fitted monthly climatology on 0.25-degree grid",
    ...
    ds_fit["clim_tmax_rf_fit"].attrs = {
        "long_name": "RF-005 fitted monthly climatology on training grid",
    ...
    ds_fit.to_netcdf(
        args.fit_nc,
        encoding={"clim_tmax_rf_fit": {"zlib": True, "complevel": 4, "dtype": "float32"}},
    )
